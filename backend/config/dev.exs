...
config :burrow, Burrow.Repo,
  ...
  database: System.get_env("POSTGRES_DB", "burrow_dev"),
  stacktrace: true,
...
config :burrow, BurrowWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Z2YBkV+Tgwr1+xPtqNKbRjTZVN7c7mUcNQ70QCG6vMoHuSe1VL6+fKpb320kkV5x",
  watchers: []
...
config :burrow, dev_routes: true

# Disable replay guard and request signatures in dev (no frontend signing in dev)
config :burrow,
